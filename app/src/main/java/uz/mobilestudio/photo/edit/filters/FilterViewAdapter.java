package uz.mobilestudio.photo.edit.filters;
...
public class FilterViewAdapter extends RecyclerView.Adapter<FilterViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(uz.mobilestudio.photo.R.layout.row_filter_view, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            mImageFilterView = itemView.findViewById(uz.mobilestudio.photo.R.id.imgFilterView);
            mTxtFilterName = itemView.findViewById(uz.mobilestudio.photo.R.id.txtFilterName);
