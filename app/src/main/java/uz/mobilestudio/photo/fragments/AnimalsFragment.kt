...
import uz.mobilestudio.photo.databinding.FragmentAnimalsBinding
...
class AnimalsFragment : Fragment() {
    ...
    private fun loadCollections() {
        ...
        viewModel.getResponseSearchCollections(currentPageCollections, getString(R.string.animals))
