...
import uz.mobilestudio.photo.databinding.FragmentTechnologyBinding
...
class TechnologyFragment : Fragment() {
    ...
    private fun loadCollections() {
        ...
        viewModel.getResponseSearchCollections(currentPageCollections, getString(R.string.technology))
